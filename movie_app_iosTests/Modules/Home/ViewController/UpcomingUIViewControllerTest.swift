//
//  UpcomingUIViewControllerTest.swift
//  movie_app_iosTests
//
...
final class UpcomingUIViewControllerTest: QuickSpec {
    override func spec() {
        var sut: UpcomingUIViewController!
        var viewModel: MockHomeViewModel!
        
        beforeEach {
            viewModel = MockHomeViewModel()
            sut = UpcomingUIViewController.init(viewModel: viewModel)
