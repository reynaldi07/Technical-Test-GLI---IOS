//
//  MovieReviewViewControllerTest.swift
//  movie_app_iosTests
//
...
final class MovieReviewViewControllerTest: QuickSpec {
    override func spec() {
        var sut: MovieReviewViewController!
        var viewModel: MockMovieReviewViewModel!
        
        beforeEach {
            viewModel = MockMovieReviewViewModel()
            sut = MovieReviewViewController()
        ...
        describe("Movie Review Controller") {
//            it("sut is not nil") {
//                sut.viewDidLoad()
